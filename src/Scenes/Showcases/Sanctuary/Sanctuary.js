    ...
    return (
      ...
      <section>
        ...
        <Helmet>
          ...
          <meta name="description" content="Take a look at my work with Sanctuary" />
        </Helmet>
        ...
        <div className="o-wrapper">
          <div className="o-layout u-margin-bottom-large">
            ...
            <div className="o-layout__item u-1/1 u-1/2@tablet">
              ...
              <p>Currently using Apple / Android Pay subscription payments via an app links a personal account, something we thought not many managers / fire wardens would be keen on doing. There's also a chance uninstalling the app could cause a payment to get cancelled, not great if someone leaving the company could mean the company losing the app.</p>
            </div>

            <div className="o-layout__item u-1/1 u-1/2@tablet">
              <h3 className="u-text-align--center">The solution</h3>

              <p>Sanctuary's web app is dedicated to registering a new company, creating an admin account and to managing the employees in a really simple way.</p>
        ...
        <div className="o-wrapper">
          ...
          <div className="o-layout u-margin-bottom-large">
            <div className="o-layout__item u-1/1">
              ...
              <ol>
                <li><b>Staff management.</b> Remove users, change email address / password & ability to convert employees to Moderators.</li>
                <li><b>Registration.</b> Add a company to website.</li>
                <li><b>Information.</b> Document app features and user guides.</li>
              </ol>

        ...
        <div className="o-wrapper">
          <div className="o-layout u-margin-bottom-large">
            <div className="o-layout__item u-1/1 u-1/2@tablet">
              ...
              <p>
                Roll calls are outdated. Having a sheet of paper which could
                have thousands of names on it, getting all the employees to
                congregate in a certain area and then trying to figure out if
                the missing employees are sick or out of office at a business
                meeting. What a nightmare.
              </p>
            </div>
            ...
            <div className="o-layout__item u-1/1 u-1/2@tablet">
              ...
              <p>
                At Sanctuary we've simplified this experience. Each employee has
                a profile, which takes around 2 minutes to create. Now if there
                is a fire, with one step you can send a push notification to
                everyone. All your employees need to do is mark themselves
                either as safe or not safe. By doing this you can get a
                real-time response from all of the employee's whether they're in
                the office or not.
              </p>
            </div>
          </div>
        ...
        <div className="o-wrapper">
          ...
          <div className="o-layout u-margin-bottom-large">
            <div className="o-layout__item u-1/1">
              <ol>
                <li>
                  <b>Push Notifications.</b> Due to the possibility that
                  employees may be out of the office, we need to alert them that
                  an active event has been triggered.
                </li>
                <li>
                ...
                <li>
                  ...
                  can view your complete employee list. Next to each users name
                  is an indication of if the employee is safe, unsafe or has not
                  yet responded. There's also a counter at the top of the page
                  for a full overview.
                </li>
              </ol>
            </div>

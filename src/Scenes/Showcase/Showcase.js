      ...
      <section className="u-padding-top-large">
        ...
        <div className="o-wrapper">
          ...
          <div className="o-layout c-previews">
            ...
            <Preview src={ThumbJPG_tchoi} company={'Tchoi design'} desc={`Cooltrax the app was an iOS &amp; Android app built for the technicians working with the company BevWizz. BevWizz needed a way to know what job a technician was currently doing and or going to do in that day. They also needed to know how long the job would take, what was the problem, how much would/ did it cost to complete the work, where they currently was, etc.`} />
